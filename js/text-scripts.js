...
if (!$('body').hasClass("is-admin")) {
    $('.procedures.slider').each(function () {
        ...
        $procedSlider.owlCarousel({
            ...
            dotsEach:3,
            slideBy:3,
            dotsContainer:$procedSliderContainer.find('[s-control="procedures"] .slider__nav__container'),
            responsive: {
                0: {
                    items: 1,
                    slideBy:1,
        ...
        $procedSliderContainer.find('[s-control="procedures"] .prev').on('click',function () {
            $procedSlider.trigger('prev.owl.carousel');
        });
        $procedSliderContainer.find('[s-control="procedures"] .next').on('click',function () {
